...
/*   Updated: 2018/07/18 18:04:16 by jjanin-r    ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
void		ft_sti(t_process **proc)
{
	...
	g_vm->map[aim] = (*proc)->registers[(*proc)->fetchqueue[0][1]] >> 6 & 0x3;
	g_vm->map[aim + 1] = (*proc)->registers[(*proc)->fetchqueue[0][1]] >> 4 & 0x3;
	g_vm->map[aim + 2] = (*proc)->registers[(*proc)->fetchqueue[0][1]] >> 2 & 0x3;
	g_vm->map[aim + 3] = (*proc)->registers[(*proc)->fetchqueue[0][1]] & 0x3;
}
